...
let editorTarget = Target {oName = "editor", oAddress = "127.0.0.1", oPort = 6012, oLatency = 0.02, oSchedule = Pre BundleStamp, oWindow = Nothing, oHandshake = False, oBusPort = Nothing }
let editorShape = OSCContext "/editor/highlights"

tidalInst <- mkTidalWith [(superdirtTarget { oAddress = "127.0.0.1", oPort = 57121 }, [superdirtShape]), (editorTarget, [editorShape])] (defaultConfig {cCtrlAddr = "127.0.0.1", cCtrlPort = 6011})
